CREATE OR REPLACE FUNCTION public.get_closer_call_metrics(target_date date)
 RETURNS TABLE(id uuid, full_name text, total_calls bigint, offered_amount numeric, cash_collected numeric, converted_count bigint, not_converted_count bigint, rescheduled_count bigint, pending_count bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
