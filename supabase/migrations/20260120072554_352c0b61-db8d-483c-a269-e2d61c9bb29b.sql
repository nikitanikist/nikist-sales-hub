...
-- Update get_workshop_calls_by_category to use mango_id and workshop.start_date
...
BEGIN
  ...
  -- REJOIN: Leads whose first workshop (by start_date within same mango_id) is THIS one, but paid in a DIFFERENT workshop
  ...
  -- CROSS-WORKSHOP: Leads whose first workshop (by start_date) is DIFFERENT, but paid in THIS workshop  
